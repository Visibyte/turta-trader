...
var ownerAndPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownsProductFileIds, orders, purchasedProductFileIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    purchasedProductFileIds = orders
                        ...
                        return order.products.map(function (product) {
                            if (typeof product === "string")
                                return req.payload.logger.error("Insufficient search depth to find purchased product ids");
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownsProductFileIds, true), purchasedProductFileIds, true),
                            },
                        }];
            }
        });
